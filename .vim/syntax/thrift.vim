...
" String
syn region thriftString matchgroup=None start=+"+  end=+"+

" Number
syn match thriftNumber "-\=\<\d\+\>"

" Keywords
syn keyword thriftKeyword namespace typedef throws extends oneway
...
" Structure
syn keyword thriftStructure map list set struct service exception enum
...
if version >= 508 || !exists("did_thrift_syn_inits")
  ...
  HiLink thriftKeyword Statement
