...
syn match   asComment         "//.*$" contains=asCommentTodo,@Spell
syn region  asComment         start="/\*"  end="\*/" contains=asCommentTodo,@Spell
...
syn keyword asGlobal          NaN Infinity undefined eval escape parseInt parseFloat isNaN isFinite decodeURI decodeURIComponent encodeURI encodeURIComponent

syn keyword asType            Object Function Array String Boolean Number Date Error XML XMLList
...
" Flex metadata
syn keyword asMetadataTag     Bindable DefaultProperty Effect Embed Event Exclude IconFile Inspectable MaxChildren ResourceBundle Style contained
syn region  asMetadata        start="^\s*\[" skip="\\\\\|\\" end="\]" contains=asMetadataTag,asStringDQ,asStringSQ,asComment
"syn region  asStringDQ	      start=+"+  skip=+\\\\\|\\"+  end=+"+
...
hi def link asAttribute       StorageClass
