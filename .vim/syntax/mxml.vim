...
if main_syntax != 'actionscript' || exists("actionscript")
  ...
  unlet b:current_syntax
  syn region  Script start=+<mx:Script[^>]*>+ keepend end=+</mx:Script>+me=s-1 contains=@mxmlScript,mxmlCssStyleComment,mxmlScriptTag,@htmlPreproc,xmlCdataStart,xmlCdataEnd
  syn region  mxmlScriptTag     contained start=+<mx:Script+ end=+>+       contains=htmlTagN,htmlString,htmlArg,htmlValue,htmlTagError,htmlEvent,xmlTagName
  syn region  Script start=+<fx:Script[^>]*>+ keepend end=+</fx:Script>+me=s-1 contains=@mxmlScript,mxmlCssStyleComment,mxmlScriptTag,@htmlPreproc,xmlCdataStart,xmlCdataEnd
  syn region  mxmlScriptTag     contained start=+<fx:Script+ end=+>+       contains=htmlTagN,htmlString,htmlArg,htmlValue,htmlTagError,htmlEvent,xmlTagName
  MXMLHiLink mxmlScriptTag xmlTag

  " Embedded CSS
  syn include @mxmlStyle syntax/mxmlcss.vim
  unlet b:current_syntax
  syn region  Style start=+<mx:Style[^>]*>+ keepend end=+</mx:Style>+me=s-1 contains=@mxmlStyle,mxmlStyleTag,xmlCdataStart,xmlCdataEnd
  syn region  mxmlStyleTag     contained start=+<mx:Style+ end=+>+       contains=htmlTagN,htmlString,htmlArg,htmlValue,htmlTagError,htmlEvent,xmlTagName
  syn region  Style start=+<fx:Style[^>]*>+ keepend end=+</fx:Style>+me=s-1 contains=@mxmlStyle,mxmlStyleTag,xmlCdataStart,xmlCdataEnd
  syn region  mxmlStyleTag     contained start=+<fx:Style+ end=+>+       contains=htmlTagN,htmlString,htmlArg,htmlValue,htmlTagError,htmlEvent,xmlTagName
  MXMLHiLink mxmlStyleTag xmlTag
...
if main_syntax == "mxml"
  ...
  syn sync match mxmlHighlight groupthere Style "<mx:Style"
...
MXMLHiLink xmlCdataCdata	Type
MXMLHiLink xmlCdataStart	Special
MXMLHiLink xmlCdataEnd		Special
...
"MXMLHiLink mxmlSpecialTagName    Function 
